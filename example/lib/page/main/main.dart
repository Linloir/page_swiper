  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: PageSwiper(
        ...
        titleMaxExtend: 1.3,
        titles: [
          PageTitle.builder(title: "All Photos", subtitle: "All photo page", actions: [TextButton(onPressed: (){}, child: const Text("Select"))]),
          PageTitle.builder(title: "Albums", subtitle: "Photo albums"),
        ],
        pages: [
